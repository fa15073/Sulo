...
FlashPlayerConfigBuilder::FlashPlayerConfigBuilder(void)
{
	...
	m_supportedConfigs["21.0.0.242_winax"].versionStr = "WIN 21,0,0,242";
	m_supportedConfigs["21.0.0.242_winax"].versionStrRVA = 0xd36634;
	m_supportedConfigs["21.0.0.242_winax"].setInterpRVA = 0x7d9a27;
	m_supportedConfigs["21.0.0.242_winax"].verifyOnCallRVA = 0x7d9471;
	m_supportedConfigs["21.0.0.242_winax"].byteArrayVTableRVA = 0xe4a900;
	m_supportedConfigs["21.0.0.242_winax"].byteArrayOffsetInByteArrayObject = 0x18;
	m_supportedConfigs["21.0.0.242_winax"].bufferOffsetInByteArray = 0x2C;
	m_supportedConfigs["21.0.0.242_winax"].dataOffsetInByteArrayBuffer = 0x08;
	m_supportedConfigs["21.0.0.242_winax"].countOffsetInByteArrayBuffer = 0x10;
	m_supportedConfigs["21.0.0.242_winax"].stringVTableRVA = 0xe4b298;
	m_supportedConfigs["21.0.0.242_winax"].stringLengthOffset = 0x10;
	m_supportedConfigs["21.0.0.242_winax"].stringBufferOffset = 0x8;
	m_supportedConfigs["21.0.0.242_winax"].m_flash_version = VER_15;
	m_supportedConfigs["21.0.0.242_winax"].methodInfoOffsetInMethodEnv = 0x8;
	m_supportedConfigs["21.0.0.242_winax"].traitsOffsetInMethodInfo = 0x10;
	m_supportedConfigs["21.0.0.242_winax"].traitsOffsetInScope = 0xC;
	m_supportedConfigs["21.0.0.242_winax"].invokerOffsetInMethodInfo = 0x8;
	m_supportedConfigs["21.0.0.242_winax"].abcInfoPosOffsetInMethodInfo = 0x1c;
	m_supportedConfigs["21.0.0.242_winax"].flagsOffsetInMethodInfo = 0x30;
	m_supportedConfigs["21.0.0.242_winax"].poolOffsetInMethodInfo = 0x18;
	m_supportedConfigs["21.0.0.242_winax"].methodIdOffsetInMethodInfo = 0x20;
	m_supportedConfigs["21.0.0.242_winax"].posTypeOffsetInTraits = 0x81;
	m_supportedConfigs["21.0.0.242_winax"].initOffsetInTraits = 0x50;
	m_supportedConfigs["21.0.0.242_winax"].traitsPosOffsetOffsetInTraits = 0x58;
	m_supportedConfigs["21.0.0.242_winax"].namespaceOffsetInTraits = 0x44;
	m_supportedConfigs["21.0.0.242_winax"].nameOffsetInTraits = 0x48;
	m_supportedConfigs["21.0.0.242_winax"].uriOffsetInNamespace = 0xC;
	m_supportedConfigs["21.0.0.242_winax"].methodsOffsetInPoolObject = 0xC4;
	m_supportedConfigs["21.0.0.242_winax"].methodNameIndicesOffsetInPoolObject = 0xD4;
	m_supportedConfigs["21.0.0.242_winax"].precompNamesOffsetInPoolObject = 0x84;
	m_supportedConfigs["21.0.0.242_winax"].namespacesOffsetInNamespaceSet = 0x8;
	m_supportedConfigs["21.0.0.242_winax"].multinameSize = 0x10;
	m_supportedConfigs["21.0.0.242_winax"].precompNamesHeaderSize = 0x0c;
	m_supportedConfigs["21.0.0.242_winax"].debugBuild = false;

	m_supportedConfigs["21.0.0.242_win_sa"].versionStr = "WIN 21,0,0,242";
	m_supportedConfigs["21.0.0.242_win_sa"].versionStrRVA = 0x945700;
	m_supportedConfigs["21.0.0.242_win_sa"].setInterpRVA = 0x73ea47;
	m_supportedConfigs["21.0.0.242_win_sa"].verifyOnCallRVA = 0x73e491;
	m_supportedConfigs["21.0.0.242_win_sa"].byteArrayVTableRVA = 0xa63410;
	m_supportedConfigs["21.0.0.242_win_sa"].byteArrayOffsetInByteArrayObject = 0x18;
	m_supportedConfigs["21.0.0.242_win_sa"].bufferOffsetInByteArray = 0x2C;
	m_supportedConfigs["21.0.0.242_win_sa"].dataOffsetInByteArrayBuffer = 0x08;
	m_supportedConfigs["21.0.0.242_win_sa"].countOffsetInByteArrayBuffer = 0x10;
	m_supportedConfigs["21.0.0.242_win_sa"].stringVTableRVA = 0xa61a54;
	m_supportedConfigs["21.0.0.242_win_sa"].stringLengthOffset = 0x10;
	m_supportedConfigs["21.0.0.242_win_sa"].stringBufferOffset = 0x8;
	m_supportedConfigs["21.0.0.242_win_sa"].m_flash_version = VER_15;
	m_supportedConfigs["21.0.0.242_win_sa"].methodInfoOffsetInMethodEnv = 0x8;
	m_supportedConfigs["21.0.0.242_win_sa"].traitsOffsetInMethodInfo = 0x10;
	m_supportedConfigs["21.0.0.242_win_sa"].traitsOffsetInScope = 0xC;
	m_supportedConfigs["21.0.0.242_win_sa"].invokerOffsetInMethodInfo = 0x8;
	m_supportedConfigs["21.0.0.242_win_sa"].abcInfoPosOffsetInMethodInfo = 0x1c;
	m_supportedConfigs["21.0.0.242_win_sa"].flagsOffsetInMethodInfo = 0x30;
	m_supportedConfigs["21.0.0.242_win_sa"].poolOffsetInMethodInfo = 0x18;
	m_supportedConfigs["21.0.0.242_win_sa"].methodIdOffsetInMethodInfo = 0x20;
	m_supportedConfigs["21.0.0.242_win_sa"].posTypeOffsetInTraits = 0x81;
	m_supportedConfigs["21.0.0.242_win_sa"].initOffsetInTraits = 0x50;
	m_supportedConfigs["21.0.0.242_win_sa"].traitsPosOffsetOffsetInTraits = 0x58;
	m_supportedConfigs["21.0.0.242_win_sa"].namespaceOffsetInTraits = 0x44;
	m_supportedConfigs["21.0.0.242_win_sa"].nameOffsetInTraits = 0x48;
	m_supportedConfigs["21.0.0.242_win_sa"].uriOffsetInNamespace = 0xC;
	m_supportedConfigs["21.0.0.242_win_sa"].methodsOffsetInPoolObject = 0xC4;
	m_supportedConfigs["21.0.0.242_win_sa"].methodNameIndicesOffsetInPoolObject = 0xD4;
	m_supportedConfigs["21.0.0.242_win_sa"].precompNamesOffsetInPoolObject = 0x84;
	m_supportedConfigs["21.0.0.242_win_sa"].namespacesOffsetInNamespaceSet = 0x8;
	m_supportedConfigs["21.0.0.242_win_sa"].multinameSize = 0x10;
	m_supportedConfigs["21.0.0.242_win_sa"].precompNamesHeaderSize = 0x0c;
	m_supportedConfigs["21.0.0.242_win_sa"].debugBuild = false;
